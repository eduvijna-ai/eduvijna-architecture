...
| [ADR-AIEOS-058](../decisions/ADR-AIEOS-058-aieos-student-assignment-consumption-learner-attempt-authority.md) — Student Assignment Consumption & Learner Attempt Authority (AIEOS360-S01) | **Proposed / Freeze Candidate** | AIEOS360-S01 discovery ACCEPTED; Learning-domain LearnerAttempt + immutable LearnerSubmission; live membership façade; exact assigned ContentVersion; learner-safe positive allowlist projection; S01 one-attempt policy; ClassroomAssessment unchanged; **Founder freeze not granted**; **S01-I01+ not authorized** |
