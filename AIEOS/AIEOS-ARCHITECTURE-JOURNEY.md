...
| Field | Content |
|-------|---------|
| **Objective** | Propose architecture for AIEOS360-S04 Admin / ERP Context as the external current-authority boundary completing the AIEOS360 vertical: one coherent school-context fact universe projected through the four existing School Context ports; Admin / ERP / SIS remains business master; AIEOS does not become a competing school / roster / family SoR. |
...
| **What was deposited** | Architecture source only: [ADR-AIEOS-062](../decisions/ADR-AIEOS-062-aieos-admin-erp-school-context-current-authority-boundary.md) **Proposed** v1.0.0 (AIEOS360-S04P2). **Not Frozen / Approved.** Lineage: **AIEOS360-S04P1 discovery = ACCEPTED / PASS.** Option A proposed direction; Option B rejected; Option C deferred; Option D is Option A specialization. |
| **What is deliberately NOT implemented / authorized** | Backend; Frontend; Product; Infrastructure; migration; OpenAPI; School Context code; coherent provider implementation; Admin OS; Admin UI; production ERP/SIS adapter; `PrincipalKind.ADMIN`; `admin.*` capability; AIEOS school / class / roster / enrollment / family tables; NATS; Temporal; production event publication; S04-I01–I03; S04 implementation. |
| **Governing decisions** | ADR-AIEOS-062 (**Proposed**); ADR-AIEOS-023R1 / 030 / 031 / 053 / 054 / 055 / 056 / 058 / 059 / 060 / 061 remain Frozen / Approved and are not reopened. |
| **Subsequent authorized implementation** | **NONE.** This deposit does **not** authorize implementation. |
| **Current status** | **Proposed.** Founder / Product Architecture freeze: **NOT GRANTED.** **IMPLEMENTATION NOT AUTHORIZED.** **AIEOS360-S03 remains DEVELOPMENT SLICE COMPLETE / CLOSED.** **Production Ready = NO.** |
