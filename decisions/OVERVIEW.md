...
| [ADR-AIEOS-058](ADR-AIEOS-058-aieos-student-assignment-consumption-learner-attempt-authority.md) | AIEOS Student Assignment Consumption & Learner Attempt Authority (**Proposed / Freeze Candidate** — AIEOS360-S01; v1.0.1; discovery ACCEPTED; Founder freeze **not** granted; implementation **not** authorized) |
