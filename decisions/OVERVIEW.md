...
| [ADR-AIEOS-058](ADR-AIEOS-058-aieos-student-assignment-consumption-learner-attempt-authority.md) | AIEOS Student Assignment Consumption & Learner Attempt Authority (**Frozen / Approved** — AIEOS360-S01; Founder / Product Architecture **2026-09-08**; Chief Architect **ACCEPTED / PASS**; v1.0.2; implementation **not** authorized; **S01-I01** = **NEXT CANDIDATE, NOT YET AUTHORIZED**) |
